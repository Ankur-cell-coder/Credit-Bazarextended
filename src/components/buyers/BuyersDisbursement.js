              ...
              <div>
                {!open4 ? (
                  ...
                  <div>
                    ...
                    <div className="bwcontent">
                      <div className="Dusbursement details">
                        <h1>Disbursement Information</h1>
                    ...
                    <div className="bwcontent">
                      <div className="Dusbursement details">
                        ...
                        <div className="Disbursement-confirmation">
                          <h2>Disbursement Confirmation</h2>
                          <p>
                            IDFC Bank has made the disbursement for your
                            invoice/Purchase order, which corresponds to the
                            finance request submitted by the seller.
                            Confirmation Number: ABD245{" "}
                          </p>
                        </div>
                      </div>
                    </div>
