              ...
              <div id="container">
                ...
                <div className="offer-card">
                  <div className="lender-details">
                    ...
                    <p>
                      <strong>Prime Textiles</strong>
                    </p>
                    <p>
                      <strong>Offered Amount:</strong>INR 4,00,000
                    </p>
                  </div>
                ...
                <div className="offer-card">
                  <div className="lender-details">
                    <h2>Request for Finance 2</h2>
                    <p>
                      <strong>Seller B</strong>
                    </p>
                    <p>
                      <strong>Requested Amount:</strong> INR 1,40,000
                    </p>
                  </div>
                  <div className="select-btn-container">
                    <button
                ...
                <div className="offer-card">
                  <div className="lender-details">
                    ...
                    <p>
                      <strong>Seller C</strong>
                    </p>
                    <p>
                      <strong>Offered Amount:</strong> INR 1,80,000
                    </p>
                  </div>
                  <div className="select-btn-container">
                    <button
