    ...
    <NavbarSide/>
     <Request1>
        ...
        <div className='button'>
          <button className='btn1' onClick={()=>{navigate('/request_information')}}>Request Information</button>
          ...
          <button className='btn' onClick={()=>{navigate('/payment')}}>Payment</button>
          <button className='btn' onClick={()=>{navigate('/settlement')}}>Settlement</button>
        </div>
        <div className='content'>
          This is Information Request Page!....
        </div>
     </Request1>
