...
function SellerPayments() {
  ...
  <div className="header">
    ...
    <p>Process your payment securely and conveniently. Use our QR code for a quick transaction.</p>
  </div>
  <div className="qr-code">
    <img src={qimg} alt="QR Code" />
  </div>
  <div className="content">
    ...
    <form>
      ...
      <button className="btn" onClick={()=>{navigate('/sellerspaymentacknowledgement')}}>Process Payment</button>
    </form>
  </div>
